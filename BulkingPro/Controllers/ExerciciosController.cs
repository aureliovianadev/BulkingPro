...
namespace BulkingPro.Controllers
{
    public class ExerciciosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Exercicios.Include(e => e.GrupoMuscular);
        ...
        {
            ViewData["GrupoMuscularId"] = new SelectList(_context.GruposMusculares, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,GrupoMuscularId,InstrucoesExecucao,Ativo,DataCriacao,DataAtualizacao")] Exercicio exercicio)
        {
            ...
            ViewData["GrupoMuscularId"] = new SelectList(_context.GruposMusculares, "Id", "Id", exercicio.GrupoMuscularId);
            return View(exercicio);
        }
